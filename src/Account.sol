 ...
 * @author Jayden Windle (jaydenwindle) / Alexei Varabei (alexthelaw)
 */
contract Account is IERC165, IERC1271, IAccount, MinimalReceiver {
     ...
     * When the token controlling the account is transferred, the implementation address will reset (public for revoke)
     *
     * @param _executionModule the address of the execution module
     */
    function setExecutor(address _executionModule) public onlyUnlocked {
        address _owner = owner();
